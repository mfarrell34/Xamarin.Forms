...
namespace Xamarin.Forms.Material.Android
{
	public class MaterialContextThemeWrapper : ContextThemeWrapper
	{
		...
		public static void TestForThemeResId(Context context, int themeResId)
		{			
			var result = context.Resources.GetResourceName(themeResId);

			if (string.IsNullOrWhiteSpace(result))
				throw new System.Exception("Unable to locate theme res Id");
		}

		public static MaterialContextThemeWrapper Create(Context context, int themeResId)
		{
			TestForThemeResId(context, themeResId);
